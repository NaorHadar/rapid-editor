...
set CommonLinkerFlags=-incremental:no  user32.lib gdi32.lib winmm.lib opengl32.lib SDL2.lib SDL2main.lib 
set CommonIncludeFlags=-I ..\deps\SDL\include -I ..\deps\gl3w\include -I ..\code

set AddLibsx64=-LIBPATH:..\deps\SDL\VisualC\x64\Release
